  ...
  */
  ...
  public class MultipletaskToComplete
  {
    ...
    */
    ...
    static Task ThrowNowImplmentedExceptionAsync()
    {
      throw new NotImplementedException();
    }

    static Task ThrowInvalidOperationExceptionAsync()
    {
      throw new InvalidOperationException();
    }

    static async Task ObserveExceptionAsync()
    {
      try
      {
     ...
     static async Task ObserveExceptionAsyncAll()
    {
